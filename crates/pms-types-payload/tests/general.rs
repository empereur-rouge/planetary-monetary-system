...
fn mvp_encrypt_decrypt_confidential_type_only() {
    ...
    match back {
        ...
        PlainPayload::MarketSettle { .. } => println!("Type = MarketSettle"),
        ...
        PlainPayload::GovernanceProposal { .. } => println!("Type = GovernanceProposal"),
        PlainPayload::GovernanceEnact { .. } => println!("Type = GovernanceEnact"),
        PlainPayload::GovernanceCancel { .. } => println!("Type = GovernanceCancel"),
